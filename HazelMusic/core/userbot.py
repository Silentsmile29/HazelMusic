...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
                await self.one.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
                await self.one.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
                await self.one.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
                await self.one.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
                await self.two.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
                await self.two.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
                await self.two.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
            except:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
                await self.three.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
                await self.three.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
                await self.three.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
            except:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
                await self.four.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
                await self.four.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
                await self.four.oin_chat("https://t.me/+7K0IMwbLvAQwYmY1")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
                await self.five.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
                await self.five.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
                await self.five.join_chat("https://t.me/+7K0IMwbLvAQwYmY1")
            except:
